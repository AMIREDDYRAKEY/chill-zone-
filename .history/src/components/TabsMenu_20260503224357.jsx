...
const TabsMenu = () => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 justify-items-center gap-3 mt-10 px-[40px">
        {filteredItems.map((item, i) => (
          <div
            key={i}
            className={`bg-[#0a0f1e] flex items-center justify-center h-[250px] w-[390px] border rounded-lg
