  ...
  return (
    <div className="min-h-screen bg-[#0f1115] text-white px-4 sm:px-6 lg:px-12 py-24">
      ...
      <div className="mt-[-40px] mb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div
            ...
            className="hidden sm:block bg-[#2563eb]
            hover:bg-[#1d4ed8]
            cursor-pointer
      ...
      <div
        ...
        hover:bg-[#1d4ed8]
        cursor-pointer
        shadow-2xl px-5 py-4 rounded-full
      ...
      <div className="flex flex-wrap gap-3 mb-3">
        ...
        {["All", "Ice Cream", "Milk Shake", "Mojito"].map(
          (cat) => (
            <button
              key={cat}
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between mb-5">
        ...
        <input
          ...
          text-sm focus:border-[#2563eb] transition"
        />

        <select
          value={sortType}
          onChange={(e) => setSortType(e.target.value)}
          className="bg-[#1a1d24] text-gray-400 border border-[#2b2f38]
          rounded-xl px-4 py-3 outline-none text-sm
          focus:border-[#2563eb] transition w-full md:w-[220px]"
        >
