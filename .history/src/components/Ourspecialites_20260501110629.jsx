    ...
    return (
        <div>
            ...
            <div className='flex justify-center gap-3 items-center'>
                <h1 className='text-4xl font-semibold '> Our Specialties </h1>
                     <span className='text-[#ec4899] text-4xl font-semibold'>Crafted with Pure Bliss</span>
            </div>
            {/* paragraph */}
            <div className='flex justify-center items-center mt-3'>
                <p>Every scoop is a masterpiece, made fresh daily with the finest ingredients.</p>
            </div>
        </div>
    )
}
