        ...
        <div>
            ...
            <div className='flex  flex-col items-center gap-3 justify-center'>
              <div className='flex gap-3'>  <span className='text-5xl font-semibold text-[#ec4899]' > Where Every</span> <h1  className='text-5xl font-semibold'> Scoop Tells a Story</h1></div>
               <p className='tr'>Born in 2018 in the heart of Hyderabad, Chill Zone was founded on one simple belief — great ice cream should be an experience, not just a dessert.</p>
            </div>
        </div>
    )
}
