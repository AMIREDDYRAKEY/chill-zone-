...
const Register = () => {
  return (
    <div className=" flex items-center justify-center bg-[#0a1727] px-4 py-10">

      {/* Form Container */}
      <div className="w-full h-[550px] max-w-lg bg-[#0a1727] border border-[#1f2937] rounded-3xl p-8 shadow-2xl">
