...
const Login = () => {
  ...
  return (
    <div className="h-[100px] flex items-center justify-center px-4 bg-gradient-to-br from-[#09071a] via-[#0e0b22] to-[#120920]">

      <div className="w-full max-w-md bg-[#0a1727]/80 backdrop-blur-xl border border-[#1d2736] rounded-3xl shadow-2xl">
