...
const TabsMenu = () => {
  ...
  return (
    <div>
        ...
        <div>
            <div className="  grid  grid-cols-2 gap-3 justify-items-center mt-10">
        {filteredItems.map((item, i) => (
          <div key={i} className="flex items-center justify-center gap-4 h-[300px] w-[500px] border rounded-lg">
            {item.name}
          </div>
        ))}
      </div>
