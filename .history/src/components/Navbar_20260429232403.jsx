...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-between items-center backdrop-blur-lg bg-[#04081a] border-b border-white/10">
      
      {/* Logo */}
      <h1 className="text-xxl font-bold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">
        Chill<span className="text-[#ec4899] text-2xl">Zone</span> 🍦
      </h1>
