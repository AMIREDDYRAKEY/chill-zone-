  ...
  return (
    <div>
        ...
        <div className='flex  flex-col items-center  justify-center'>
              <div className='flex gap-3'>  <span className='text-6xl font-semibold  text-[#ec4899] ' > What Our</span> <h1  className='text-5xl font-semibold  '> fans Says </h1></div>
              <div> <p>Real stories from real ice cream lovers who can't stop coming back.</p></div>
            </div>
    </div>
  )
}
