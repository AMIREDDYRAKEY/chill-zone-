...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-4 sm:px-6 py-4 flex justify-between items-center backdrop-blur-lg bg-[#020617]/60 border-b border-white/10">
      ...
      {/* Logo */}
      <a href="#" className="text-lg sm:text-xl font-bold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">
      ...
      <a
        href="#cta"
        className="hidden md:block px-5 py-2 rounded-full text-sm bg-gradient-to-r from-cyan-400 to-purple-500 hover:opacity-80"
      >
        Order Now →
      </a>
      ...
      {/* Mobile Menu */}
      <div className={`absolute top-full left-0 w-full bg-[#020617]/95 backdrop-blur-lg border-b border-white/10 transition-all duration-300 
