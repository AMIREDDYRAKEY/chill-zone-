...
const Register = () => {
  return (
    <div className="h-[450px] flex items-center justify-center bg-[#10253f] px-4 py-10">

      {/* Form Container */}
      <div className="w-full max-w-lg   border border-[#1f2937] rounded-3xl p-8 shadow-2xl">
