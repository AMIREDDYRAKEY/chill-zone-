  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(260px circle at ${pos.x} ${pos.y}, rgba(139,92,246,0.08), transparent 75%)`,
        }}
      />
      ...
      <div className="relative z-20 text-center px-6 pt-28 pb-20 max-w-4xl mx-auto w-full">
        ...
        >
          <span className="block text-4xl md:text-6xl lg:text-7xl text-white/90 mb-2">
            Life's Too Short
          </span>
          <span
