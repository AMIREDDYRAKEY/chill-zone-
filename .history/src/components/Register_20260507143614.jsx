...
const Register = () => {
  return (
    <div className="h-[300px] flex items-center justify-center  bg-gradient-to-br from-[#09071a] via-[#0e0b22] to-[#120920]">

      <div className="w-full max-w-lg bg-[#0a1727]/80 backdrop-blur-xl border border-[#1d2736] rounded-3xl  shadow-2xl">
