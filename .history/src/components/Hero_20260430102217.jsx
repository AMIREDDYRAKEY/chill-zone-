...
const Hero = () => {
  ...
  useEffect(() => {
    ...
    const onDown = () => (cursor.style.transform = "translate(-50%,-50%) rotate(-20deg) scale(0.75)");
    const onUp   = () => (cursor.style.transform = "translate(-50%,-50%) rotate(-20deg) scale(1)");
      ...
      <section className="bg-[#130d2e] relative min-h-screen flex items-center justify-center text-center px-6 pt-28 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button className="px-6 py-3 rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(168,85,247,0.4)] transition text-white font-semibold">
              Explore Menu ✦
            </button>
            <button className="px-6 py-3 rounded-full border border-white/10 text-white hover:text-cyan-400 hover:border-cyan-400/40 transition">
              Our Story
            </button>
          </div>
        </div>
