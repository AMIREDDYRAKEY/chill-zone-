    ...
    return (
        <div>
            ...
            <div className='flex justify-center items-center mt-3'>
                <p className='text-md text-[#525d70] font-semibold'>Every scoop is a masterpiece, made fresh daily with the finest ingredients.</p>
            </div>
            {/* tabs */}
              <div className='mt-10 '><TabsMenu/></div>
        </div>
    )
}
