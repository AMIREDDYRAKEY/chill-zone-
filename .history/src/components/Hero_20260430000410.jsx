...
const Hero = () => {
  ...
  return (
    <section className="bg-[] relative min-h-screen flex items-center justify-center text-center px-6 pt-28 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `radial-gradient(600px circle at ${pos.x} ${pos.y}, rgba(6,182,212,0.1), transparent 60%)`,
        }}
      />

      {/* 🟦 GRID */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(6,182,212,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(6,182,212,0.05)_1px,transparent_1px)] bg-[size:60px_60px] mask-radial-faded" />
