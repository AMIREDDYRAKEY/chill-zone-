...
const Marquee = () => {
  return (
    <div className='h-[100px] g'>
    <div className="marquee-section mt-[30px] border-t-[2px] border-[#162232] border-b-[2px] h-[65px] bg-[#110f24] flex justify-center items-center">
