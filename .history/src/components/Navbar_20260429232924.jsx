...
const Navbar = () => {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex justify-around items-center backdrop-blur-lg bg-[#04081a] border-b border-white/10">
      ...
      {/* Links */}
      <ul className="hidden md:flex gap-8 text-[16px] font-semibold text-gray-400">
