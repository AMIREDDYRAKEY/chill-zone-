      ...
      `}
          >
            ...
            <div className="flex items-center justify-center">
              <div className="text-[50px] bg-[#0f172a] h-[100px] w-[90px] flex items-center  justify-center rounded-xl border border-[#1d2230]">
                {item.logo  }
              </div>
            </div>
            ...
            <div className="flex flex-col pt-3 gap-2  w-full">
              ...
              {/* end */}
              <div className="flex items-center mt-8  justify-end gap-10 ">
                <h2 className="text-xl font-semibold text-cyan-400">
                  ₹{item.price}
                </h2>

                <span className="text-xs px-8 py-2  rounded-full border border-cyan-400/30 text-cyan-400">
                  {item.type}
                </span>
              </div>
