...
const TabsMenu = () => {
  ...
  return (
    <div>
        ...
        <div>
            <div className="  grid  grid-cols-3 gap-3 justify-items-center mt-3">
        {filteredItems.map((item, i) => (
          <div key={i} className="flex items-center justify-center gap-4 h-[400px] w-[400px] border rounded-lg">
            {item.name}
          </div>
        ))}
      </div>
