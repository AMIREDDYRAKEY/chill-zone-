  ...
  return (
    <div>
        ...
        <div className='flex  flex-col items-center  justify-center'>
              <div className='flex gap-3'>  <span className='text-5xl font-semibold text-[#ec4899]' > Visual</span> <h1  className='text-5xl font-semibold text-[#ec4899]'> feast Awaits </h1></div>
